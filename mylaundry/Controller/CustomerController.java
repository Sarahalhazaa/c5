...
public class CustomerController {
    ...
    @PostMapping("/order/{customerId}/{serviceId}/{quantity}")
    public ResponseEntity order(@PathVariable Integer customerId, @PathVariable Integer serviceId ,@PathVariable  Integer quantity ){
        customerService.order(customerId,serviceId,quantity);
