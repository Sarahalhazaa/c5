...
public class LaundryController {
    ...
    public ResponseEntity addLaundry(@PathVariable Integer owner_id , @RequestBody @Valid Laundry laundry){

        laundryService.addLaundry(owner_id,laundry);
